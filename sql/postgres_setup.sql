-- ============================================
-- Complete PostgreSQL Database Setup for Law Firm RAG System
...
-- 3. Database created (e.g., claimsboost or law_firm_rag)
--
-- Usage:
-- psql -U postgres -d your_database -f postgres_complete_setup.sql
-- ============================================
...
SELECT
  'PostgreSQL setup complete!' as status,
...
-- Notes:
-- ============================================
-- 1. Ensure Ollama is installed: ollama pull nomic-embed-text
-- 2. Configure environment variables in config/.env
-- 3. This setup uses 768 dimensions for nomic-embed-text
-- 4. All timestamps are stored with timezone
-- ============================================